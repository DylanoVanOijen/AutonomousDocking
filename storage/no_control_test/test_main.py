...
settings = {"random_seed":40,
            ...
            "gamma": 0.99,
            "buffer_size": 60000,
            "batch_size": 5000,              # num of transitions sampled from replay buffer
            "lr_actor":10**(-5),              # learning rate of actor = alpha
            "lr_critic":10**(-5),             # learning rate of critic = beta
            ...
            "n_iters":1000,                   # Number of training iterations per episode (not used anymore)
            "fc1_dim":1024,                  # Number of nodes in fully connected linear layer 1
            "fc2_dim":1024,                  # Number of nodes in fully connected linear layer 2
