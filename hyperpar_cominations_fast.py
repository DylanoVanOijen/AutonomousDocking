...
sub_dir = "hyperparameter_combinations_fast/"
...
transitions = 5*60
pars_to_loop = {"batch_size" : [5*transitions, 10*transitions, 20*transitions, 50*transitions],
                "lr" : [2*10**(-6), 5*10**(-6), 10**(-5), 2*10**(-5), 5*10**(-5), 10**(-4)],
                "n_iters": [100,500]
                }
